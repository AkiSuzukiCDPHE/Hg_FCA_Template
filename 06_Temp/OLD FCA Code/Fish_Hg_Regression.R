...
# If the filtered data has at least 3 rows, it performs linear regression (lm) on the data, this filters
...
# relationship defined by the intercept and length.
  ...
  Hg_Reg_Output3 = Hg_Reg_Output2 %>% 
    mutate(
      Pred_Length = (Children_1MealMonth - Intercept)/Length_Inches)
...
Samples_Final = bind_rows(Samples_notpred, Samples_pred2)
